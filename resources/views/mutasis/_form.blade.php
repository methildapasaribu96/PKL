<div class="form-group {!! $errors->has('peniunan_id') ? 'has-error' : '' !!}">
  {!! Form::label('peniunan_id', 'NIP', ['class'=>'col-md-2 control-label']) !!}
  <div class="col-md-4">
   {!! Form::select('peniunan_id', [''=>'']+App\Pensiunan::pluck('nip','nip')->all(), null, [
  'class'=>'js-selectize',
  'placeholder' => 'Pilih NIP']) !!}
    {!! $errors->first('peniunan_id', '<p class="help-block">:message</p>') !!}
  </div>
</div>
...
{!! Form::label('no_rek_baru', 'No Rek Bank Baru', ['class'=>'col-md-2 control-label']) !!}
<div class="col-md-4">
...
{!! Form::label('kantor_bayar_baru', 'Kantor Bayar Baru', ['class'=>'col-md-2 control-label']) !!}
<div class="col-md-4">
...
{!! Form::label('alamat_baru', 'Alamat Baru', ['class'=>'col-md-2 control-label']) !!}
<div class="col-md-4">
...
{!! Form::label('desa_baru', 'Kelurahan/Desa Baru', ['class'=>'col-md-2 control-label']) !!}
<div class="col-md-4">
...
{!! Form::label('kecamatan_baru', 'Kecamatan Baru', ['class'=>'col-md-2 control-label']) !!}
<div class="col-md-4">
...
{!! Form::label('kabupaten_baru', 'Kabupaten Baru', ['class'=>'col-md-2 control-label']) !!}
<div class="col-md-4">
...
{!! Form::label('no_telp_baru', 'No Telp Baru', ['class'=>'col-md-2 control-label']) !!}
<div class="col-md-4">
...
{!! Form::label('bulan_id', 'Bulan Mutasi', ['class'=>'col-md-2 control-label']) !!}
<div class="col-md-4">
...
{!! Form::label('no_rek_lama', 'No Rek Bank Lama', ['class'=>'col-md-2 control-label']) !!}
<div class="col-md-4">
...
{!! Form::label('kantor_bayar_lama', 'Kantor Bayar Lama', ['class'=>'col-md-2 control-label']) !!}
<div class="col-md-4">
...
{!! Form::label('alamat_lama', 'Alamat Lama', ['class'=>'col-md-2 control-label']) !!}
<div class="col-md-4">
...
{!! Form::label('desa_lama', 'Kelurahan/Desa Lama', ['class'=>'col-md-2 control-label']) !!}
<div class="col-md-4">
...
{!! Form::label('kecamatan_lama', 'Kecamatan Lama', ['class'=>'col-md-2 control-label']) !!}
<div class="col-md-4">
...
{!! Form::label('kabupaten_lama', 'Kabupaten Lama', ['class'=>'col-md-2 control-label']) !!}
<div class="col-md-4">
...
{!! Form::label('no_telp_lama', 'No Telp Lama', ['class'=>'col-md-2 control-label']) !!}
<div class="col-md-4">
...
<div class="form-group{{ $errors->has('kartu_keluarga') ? ' has-error' : '' }}">
  {!! Form::label('kartu_keluarga', 'kartu_keluarga', ['class'=>'col-md-2 control-label']) !!}
  <div class="col-md-4">
        {!! Form::File('kartu_keluarga') !!}
        @if (isset($mutasi)&& $pensiunan->kartu_keluarga)
        <p>
            {!! Html::image(asset('img/'.$pensiunan->kartu_keluarga), null, ['class'=> 'img-rounded img-responsive']) !!}
        </p>
        @endif
...
div class="form-group{{ $errors->has('ktp') ? ' has-error' : '' }}">
  {!! Form::label('ktp', 'ktp', ['class'=>'col-md-2 control-label']) !!}
  <div class="col-md-4">
        {!! Form::File('ktp') !!}
        @if (isset($mutasi)&& $pensiunan->ktp)
        <p>
            {!! Html::image(asset('img/'.$pensiunan->ktp), null, ['class'=> 'img-rounded img-responsive']) !!}
        </p>
        @endif
...
div class="form-group{{ $errors->has('sk') ? ' has-error' : '' }}">
  {!! Form::label('sk', 'sk', ['class'=>'col-md-2 control-label']) !!}
  <div class="col-md-4">
        {!! Form::File('sk') !!}
        @if (isset($mutasi)&& $pensiunan->sk)
        <p>
            {!! Html::image(asset('img/'.$pensiunan->sk), null, ['class'=> 'img-rounded img-responsive']) !!}
        </p>
        @endif
...
div class="form-group{{ $errors->has('buku_rekening') ? ' has-error' : '' }}">
  {!! Form::label('buku_rekening', 'buku_rekening', ['class'=>'col-md-2 control-label']) !!}
  <div class="col-md-4">
        {!! Form::File('buku_rekening') !!}
        @if (isset($mutasi)&& $pensiunan->buku_rekening)
        <p>
            {!! Html::image(asset('img/'.$pensiunan->buku_rekening), null, ['class'=> 'img-rounded img-responsive']) !!}
        </p>
        @endif
